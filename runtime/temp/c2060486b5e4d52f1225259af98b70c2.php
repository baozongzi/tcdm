                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-sm-8 col-xs-12">
                                                <?php switch($item['type']): case "button": ?>
                                                <div class="form-inline">
                                                    <div class="col-xs-12 col-sm-8">
                                                        <a class="vension btn btn-sm btn-success" href="javascript:;" style="color:#000">点击生成,在没有弹窗出来的情况下不要进行任何操作</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-inline">
                                                    <div class="col-xs-12 col-sm-8">
                                                        <textarea id="c-content" class="form-control summernote edit" rows="5" name="row[<?php echo $item['name']; ?>]" cols="50"><?php echo $item['value']; ?></textarea>
                                                    </div>
                                                </div>
                                                <?php break; endswitch; ?>
                                            </div>
