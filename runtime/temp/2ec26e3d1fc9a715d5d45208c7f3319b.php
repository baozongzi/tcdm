<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"D:\phpStudy\WWW\fire\public/../application/admin\view\banner\add.html";i:1531475102;s:73:"D:\phpStudy\WWW\fire\public/../application/admin\view\layout\default.html";i:1515575204;s:70:"D:\phpStudy\WWW\fire\public/../application/admin\view\common\meta.html";i:1527563835;s:45:"../application/admin/view/banner/selects.html";i:1531475023;s:72:"D:\phpStudy\WWW\fire\public/../application/admin\view\common\script.html";i:1527563882;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group" id="title" style="<?php if($row['is_link'] == 0): ?>display:none;<?php endif; ?>">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-title" class="form-control" name="row[mytitle]" type="text" value="" placeholder="没有外部链接时不用填写">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <label for="row[is_index]-normal"><input class="is_index" name="row[is_index]" type="radio" value="1"> 是</label>
            <label for="row[is_index]-normal"><input class="is_index" name="row[is_index]" checked type="radio" value="0"> 否</label>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <label for="row[is_link]-normal"><input class="is_link" name="row[is_link]" checked type="radio" value="1"> 是</label>
            <label for="row[is_link]-normal"><input class="is_link" name="row[is_link]" type="radio" value="0"> 否</label>
        </div>
    </div>
    
    <div class="form-group" id="prices" style="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" class="form-control" size="50" name="row[thumb]" type="text">
        ...
        $.ajax({
            ...
            success:function(data){
              if(data){
                ...
                for(var i = 0; i < len; i++){
                    catname_tab.append('<tr class="removes" data-index="0"> <td> <input type="checkbox" name="checkbox[]" value="'+data[i].id+'"  >  <input type="hidden" value="'+data[i].id+'"  name="ids[]" class="ids_'+data[i].id+'"/>  <input type="hidden" value="'+table+'"   class="tab_'+data[i].id+'"/> </td> <td >'+data[i].id+'</td> <td class="title_'+data[i].id+'">'+data[i].title+'</td>   <td class="catname_'+data[i].id+'">'+data[i].catname+'</td> </tr>');
                }
              }else{
                alert('数据读取失败');
              }
