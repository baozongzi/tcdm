...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-time" class="control-label col-xs-12 col-sm-2"><?php echo __('title'); ?>:</label>
    ...
    <div class="form-group">
        <label for="c-type" class="control-label col-xs-12 col-sm-2"><?php echo __('所属'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[type]">
                <option value="1" <?php if($row['catid'] == "1"): ?>selected<?php endif; ?> name="row['catid']" >关于我们</option>
                <option value="2" <?php if($row['catid'] == "2"): ?>selected<?php endif; ?> name="row['catid']" >许可协议</option>
                <option value="3" <?php if($row['catid'] == "3"): ?>selected<?php endif; ?> name="row['catid']" >隐私协议</option>
            </select>
        </div>
    </div>
...
<script>
    ...
    KindEditor.ready(function(K) {
        editor = KindEditor.create("textarea[id='ueditors']",{allowImageUpload:true,resizeType : 1,width:"100%",height:"360px"});
    });
</script>
                            </div>
                        </div>
