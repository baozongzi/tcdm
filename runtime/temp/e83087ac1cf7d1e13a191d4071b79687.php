...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[answer]" id="ueditors" cols="30" rows="10"><?php echo $row['answer']; ?></textarea>
        </div>
    </div>
