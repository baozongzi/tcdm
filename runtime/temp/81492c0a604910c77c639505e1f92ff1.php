<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/goods\_goods.html";i:1533108679;s:62:"D:\phpStudy\WWW\tcdm\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="addEditGoodsForm">
        ...
        <div class="ncap-form-default tab_div_1">
                ...
                <dd class="opt">
                    <select name="suppliers_id" id="suppliers_id" class="small form-control">
                        ...
                        <?php if(is_array($suppliersList) || $suppliersList instanceof \think\Collection || $suppliersList instanceof \think\Paginator): if( count($suppliersList)==0 ) : echo "" ;else: foreach($suppliersList as $k=>$v): ?>
                            <option value="<?php echo $v['suppliers_id']; ?>" <?php if($v['suppliers_id'] == $goods['suppliers_id']): ?>selected="selected"<?php endif; ?>>
            ...
            <dl class="row goods_shipping">
                ...
                <dd class="opt">
                  <div class="onoff">
                    <label id="is_free_shipping_label_1" for="is_free_shipping1" class="cb-enable <?php if($goods['is_free_shipping'] == 1): ?>selected<?php endif; ?>">是</label>
                    <label id="is_free_shipping_label_0" for="is_free_shipping0" class="cb-disable <?php if($goods['is_free_shipping'] == 0): ?>selected<?php endif; ?>">否</label>
                    <input id="is_free_shipping1" autocomplete="off" class="is_free_shipping" name="is_free_shipping" value="1" type="radio" <?php if($goods[is_free_shipping] == 1): ?> checked="checked"<?php endif; ?>>
                    <input id="is_free_shipping0" autocomplete="off" class="is_free_shipping" name="is_free_shipping" value="0" type="radio" <?php if($goods[is_free_shipping] == 0): ?> checked="checked"<?php endif; ?>>
                      <div class="freight_template" style="display: none;">
                          ...
                          <select name="template_id">
                              ...
                              <?php if(is_array($freight_template) || $freight_template instanceof \think\Collection || $freight_template instanceof \think\Paginator): $i = 0; $__LIST__ = $freight_template;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$template): $mod = ($i % 2 );++$i;?>
                                  <option value="<?php echo $template['template_id']; ?>"<?php if($template['template_id'] == $goods['template_id']): ?>selected="selected"<?php endif; ?>><?php echo $template['template_name']; ?></option>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <?php if($goods['goods_id'] > 0): if($goods['is_virtual'] == 1): ?>
                            <span>是</span>
            ...
            <dl class="row virtual" style="display: none;">
                ...
                <dd class="opt virtual">
                    <input id="virtual_indate" name="virtual_indate" value="<?php echo date('Y-m-d',$goods[virtual_indate]); ?>" class="input-txt" type="text">
                                ...
                                <tr>
                                    ...
                                    <?php if(is_array($goods['goods_images']) || $goods['goods_images'] instanceof \think\Collection || $goods['goods_images'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['goods_images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?>
                                        <div style="width:100px; text-align:center; margin: 5px; display:inline-block;" class="goods_xc">
                                            ...
                                            <a onClick="" href="<?php echo $image['image_url']; ?>" target="_blank"><img width="100" height="100" src="<?php echo $image['image_url']; ?>"></a>
                                            <br>
