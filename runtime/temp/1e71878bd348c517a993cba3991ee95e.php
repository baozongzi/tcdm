...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[status]">
                <option value="0" <?php if($row['status'] == "0"): ?>selected<?php endif; ?> name="row['status']" >敬请期待</option>
                <option value="1" <?php if($row['status'] == "1"): ?>selected<?php endif; ?> name="row['status']" >火热招募中</option>
                <option value="2" <?php if($row['status'] == "2"): ?>selected<?php endif; ?> name="row['status']" >已结束</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-answer" class="form-control" name="row[top_num]" type="text" value="<?php echo $row['top_num']; ?>" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[starttime]" type="text" value="<?php echo datetime($row['starttime']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <textarea name="row[description]" style="width:100%;" id="" cols="30" rows="10"><?php echo $row['description']; ?></textarea>
        </div>
    </div>
