...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" class="form-control summernote editor" rows="5" name="row[content]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-top" class="control-label col-xs-12 col-sm-2"><?php echo __('Top'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[top]', ['1'=>__('是'), '0'=>__('否')]); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-label" class="control-label col-xs-12 col-sm-2"><?php echo __('Label'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-label" class="form-control" name="row[label]" type="text">
        </div>
    </div>
