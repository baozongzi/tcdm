...
<form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="" style="float: left;">
    ...
    <input type="hidden" name="row[video]" id="videos" value="">
    <div class="form-group">
