    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[type]">
                <option value="1"  name="row['catid']" >关于我们</option>
                <option value="2"  name="row['catid']" >许可协议</option>
                <option value="3"  name="row['catid']" >隐私协议</option>
            </select>
        </div>
    </div>
