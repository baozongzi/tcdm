<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/home/wwwroot/yingshi.oyaoyin.com/public/../application/admin/view/dashboard/index.html";i:1515575204;s:86:"/home/wwwroot/yingshi.oyaoyin.com/public/../application/admin/view/layout/default.html";i:1515575204;s:83:"/home/wwwroot/yingshi.oyaoyin.com/public/../application/admin/view/common/meta.html";i:1527563835;s:85:"/home/wwwroot/yingshi.oyaoyin.com/public/../application/admin/view/common/script.html";i:1527563882;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $questionstotal; ?></span>
                                <?php echo __('总试题数'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $activetotal; ?></span>
                                <?php echo __('总活动数'); ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel bg-blue">
                            <div class="panel-body">
                                ...
                                <div class="panel-content">
                                    <h1 class="no-margins"><?php echo $categorycount; ?></h1>
                                    <div class="stat-percent font-bold text-gray"><i class="fa fa-commenting"></i> <?php echo $categorycount; ?></div>
                        ...
                        <div class="panel bg-aqua-gradient">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><?php echo $attachmentcount; ?></h1>
                                    <div class="stat-percent font-bold text-gray"><i class="fa fa-modx"></i> <?php echo $attachmentcount; ?></div>
                        ...
                        <div class="panel bg-purple-gradient">
                            <div class="panel-body">
                                <div class="ibox-title">
                                    ...
                                    <h5><?php echo __('试题统计'); ?></h5>
                                </div>
                                <div class="ibox-content">

                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $questionTrue; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-commenting"></i> <small><?php echo __('正常题库'); ?></small></div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $questionFalse; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-heart"></i> <small><?php echo __('回收站'); ?></small></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="panel bg-green-gradient">
                            <div class="panel-body">
                                <div class="ibox-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                    <h5><?php echo __('活动统计'); ?></h5>
                                </div>
                                <div class="ibox-content">

                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $activetotal; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-commenting"></i> <small><?php echo __('活动数量'); ?></small></div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $activetotalUser; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-user"></i> <small><?php echo __('报名数量'); ?></small></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
