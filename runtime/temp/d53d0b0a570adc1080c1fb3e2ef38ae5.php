...
<form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[is_fee]-normal"><input class="is_fee-normal" name="row[is_fee]" checked type="radio" value="1"> 是</label>
                <label for="row[is_fee]-normal"><input class="is_fee-normal" name="row[is_fee]" type="radio" value="0"> 否</label>
            </div>
        </div>
    </div>
    <div class="form-group">
