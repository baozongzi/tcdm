...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[time]" type="text" value="<?php echo datetime($row['time']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-describe" class="control-label col-xs-12 col-sm-2"><?php echo __('Describe'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-describe" class="form-control" name="row[describe]" type="text" value="<?php echo $row['describe']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-content" class="control-label col-xs-12 col-sm-2"><?php echo __('Content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" class="form-control summernote edit" rows="5" name="row[content]" cols="50"><?php echo $row['content']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-top" class="control-label col-xs-12 col-sm-2"><?php echo __('Top'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[top]', ['1'=>__('是'), '0'=>__('否')], $row['top']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-label" class="control-label col-xs-12 col-sm-2"><?php echo __('Label'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-label" class="form-control" name="row[label]" type="text" value="<?php echo $row['label']; ?>">
        </div>
    </div>
