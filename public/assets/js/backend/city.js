define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'city/index/cid/'+$('#cid').val(),
                    add_url: 'city/add/cid/'+$('#cid').val(),
                    edit_url: 'city/edit/cid/'+$('#cid').val(),
                    // del_url: 'city/del/cid/'+$('#cid').val(),
                    del_url: 'city/softDelete/cid/'+$('#cid').val(),
                    multi_url: 'city/multi/cid/'+$('#cid').val(),
                    table: 'city',
                }
            });
